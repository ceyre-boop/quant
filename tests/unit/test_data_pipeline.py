...
class TestDataPipeline:
    ...
    def mock_polygon(self):
        ...
        client.get_aggregates.return_value = {
            'results': [
                {'c': 20000, 'h': 20100, 'l': 19900, 'o': 19950, 'v': 1000000, 't': 1705312800000},
                {'c': 20100, 'h': 20200, 'l': 20000, 'o': 20000, 'v': 1100000, 't': 1705399200000},
                {'c': 20050, 'h': 20150, 'l': 19950, 'o': 20100, 'v': 1050000, 't': 1705485600000},
            ]
        }
        return client
    ...
    def pipeline(self, mock_polygon, mock_tradelocker):
        ...
        return DataPipeline(
            ...
            tradelocker_client=mock_tradelocker
        )
