...
## TICK-048
**title:** Triage 28 DORMANT files — wire up or retire, decided per file
**status:** open
**pre_approved:** false

**description:** The 2026-07-21 system inventory (`SYSTEM_INVENTORY.md`, generated by
`audit/system_inventory.py`) found 28 files reached by no scheduled job, no manual
entry point, and no test — built and wired to nothing. Each is a per-file decision
(wire up, or move to attic/), NOT a bulk delete. Notably includes an unfinished
`clawd_trading/swing_prediction/` cluster and a literal `TODO_COMPLETE_IMPLEMENTATION.py`.

Full list (verify each with `python3 -m audit.claim_check` before acting — DORMANT is a
reachability fact, not proof the code is worthless):

- `__init__.py`
- `check_account.py`
- `clawd_trading/infrastructure/guardrails.py`
- `clawd_trading/infrastructure/risk_manager.py`
- `clawd_trading/swing_prediction/TODO_COMPLETE_IMPLEMENTATION.py`
- `clawd_trading/swing_prediction/__init__.py`
- `clawd_trading/swing_prediction/fomc_calendar.py`
- `clawd_trading/swing_prediction/positioning_feed.py`
- `clawd_trading/swing_prediction/prediction_scrutiny.py`
- `clawd_trading/swing_prediction/real_base_rates.py`
- `data/research/sovereign_core_gauntlet/_diag_gates.py`
- `firebase/rest_client.py`
- `fix_hardcoded_equity.py`
- `models/__init__.py`
- `research/debug_indexing.py`
- `research/fvg_corridor/__init__.py`
- `research/fvg_corridor/tests/__init__.py`
- `research/fvg_corridor/tests/test_rails.py`
- `research/gapper_continuation/test_gapper.py`
- `research/movers_study/__init__.py`
- `research/political_alpha/tests/conftest.py`
- `research/political_alpha/tests/test_isolation.py`
- `research/political_alpha/tests/test_lib.py`
- `research/political_alpha_v2/tests/test_isolation.py`
- `research/yield_frontier/tests/__init__.py`
- `research/yield_frontier/tests/test_gates.py`
- `sovereign/strategies/__init__.py`
- `sovereign/strategies/strategy_selector.py`
