...
class PaperTrader:
    ...
    def open_trade(self, scan_result, tp1_r: float = TP1_R, tp2_r: float = TP2_R, risk_mult: float = 1.0) -> Optional[PaperTrade]:
        """
        ...
        risk_dollars = ACCOUNT * RISK_PCT * max(risk_mult, 0.25)
