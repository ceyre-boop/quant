...
from backtest.backtest_runner import (
    BacktestRunner, BacktestConfig, BacktestResult, BacktestMode
)
...
class WalkForwardTester:
    ...
    def _run_window(
        ...
        if not skip_training and self.backtest_config_factory:
            try:
                ...
                logger.info(f"Train period: {result.train_result.total_trades} trades, "
        ...
        if self.backtest_config_factory:
            try:
                ...
                logger.info(f"Test period: {result.test_result.total_trades} trades, "
    ...
    def print_summary(self):
        ...
        print("=" * 70)
        print(f"Configuration: {self.config.train_window_months}mo train, "
