...
class PerformanceMonitor:
    ...
    def run_weekly_analysis(
        ...
        if not trades:
            ...
            # Calculate metrics
            metrics = calculate_all_metrics(trades=trades, period_days=days_back)
    ...
    def _check_drift(self, trades: List[Dict[str, Any]]) -> tuple[bool, float]:
        ...
        correct = sum(1 for t in trades if (t.get("pnl", 0) > 0))
    ...
    def _empty_metrics(self, start_date: str, end_date: str) -> PerformanceMetrics:
