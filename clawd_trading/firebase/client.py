...
Firebase Project: taboost-platform
"""
...
from contracts.types import (
    FeatureRecord, BiasOutput, RiskOutput, GameOutput,
    RegimeState, EntrySignal, PositionState, AccountState
)
...
class FirebaseClient:
    ...
    def __init__(
        ...
        self.rtdb_url = rtdb_url or os.getenv('FIREBASE_RTDB_URL', 'https://taboost-platform-default-rtdb.firebaseio.com')
        self.auth_domain = auth_domain or os.getenv('FIREBASE_AUTH_DOMAIN', 'taboost-platform.firebaseapp.com')
        self.app_id = app_id or os.getenv('FIREBASE_APP_ID', '1:379293685859:web:d95184bc48c8cca1574056')
    ...
    def batch_write_bias_outputs(
        self,
        outputs: Dict[str, BiasOutput]
    ) -> List[str]:
    ...
    def batch_write_risk_structures(
        self,
        structures: Dict[str, RiskOutput],
        bias_ids: Dict[str, str]
    ) -> List[str]:
