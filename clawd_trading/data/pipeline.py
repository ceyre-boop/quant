...
class DataPipeline:
    ...
    def _build_features(
        ...
        # Fill remaining features with valid defaults
        default_values = {
            'returns_4h': 0.0,
            'price_vs_sma_200': 0.0,
            'price_vs_ema_12': 0.0,
            'price_vs_ema_26': 0.0,
            'price_position_daily_range': 0.5,
            'bollinger_position': 0.5,
            'bollinger_width': 0.02,  # Must be > 0
            'keltner_position': 0.5,
            'historical_volatility_20d': 0.15,
            'realized_volatility_5d': 0.12,
            'volatility_regime': 2,  # Must be 1-4
            'adx_14': 25.0,
            'dmi_plus': 25.0,
            'dmi_minus': 20.0,
            'macd_line': 0.0,
            ...
            'stochastic_d': 50.0,
            'cci_20': 0.0,
            'volume_sma_ratio': 1.0,  # Must be > 0
            'obv_slope': 0.0,
            'vwap_deviation': 0.0,
            'volume_profile_poc_dist': 0.0,
            'volume_trend_5d': 0.0,
            'swing_high_20': close * 1.05,
            'swing_low_20': close * 0.95,
            'distance_to_resistance': close * 0.02,
            'distance_to_support': close * 0.02,
            'higher_highs_5d': 2,
            'higher_lows_5d': 2
        }
