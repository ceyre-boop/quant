...
class ExecutionGuardrails:
    ...
    def validate_trade(
        ...
        checks = [
            ...
            ('position_limits', self.check_position_limits(position_size, symbol, current_positions)),
        ...
        if failed_checks:
            ...
            return GuardrailResult(
                ...
                details={
                    ...
                    'all_results': {name: result.to_dict() if hasattr(result, 'to_dict') else str(result) 
