...
class BaseRateCalculator:
    ...
    async def compute_base_rates(
        ...
        edge_confirmed = (
            win_rate_40d > min_win_rate and 
            len(occurrences) >= min_occurrences
        )
    ...
    def _empty_result(self, symbol: str, conditions: Dict) -> BaseRateResult:
        ...
        return BaseRateResult(
            ...
            n_occurrences=0,
            date_range="",
            forward_20d={"win_rate": 0, "avg_return": 0, "median_return": 0, 
                        "avg_max_drawdown": 0, "sharpe": 0},
            forward_40d={"win_rate": 0, "avg_return": 0, "median_return": 0,
                        "avg_max_drawdown": 0, "sharpe": 0},
            forward_60d={"win_rate": 0, "avg_return": 0, "median_return": 0,
                        "avg_max_drawdown": 0, "sharpe": 0},
