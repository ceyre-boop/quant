...
class XGBoostBiasModel:
    ...
    FEATURE_NAMES = [
        'returns_1h', 'returns_4h', 'returns_daily', 'returns_5d',
        'price_vs_sma_20', 'price_vs_sma_50', 'price_vs_sma_200',
        'price_vs_ema_12', 'price_vs_ema_26',
        'price_position_daily_range', 'bollinger_position', 'bollinger_width',
        'keltner_position', 'atr_14', 'atr_percent_14',
        'historical_volatility_20d', 'realized_volatility_5d', 'volatility_regime',
        'adx_14', 'dmi_plus', 'dmi_minus',
        'macd_line', 'macd_signal', 'macd_histogram',
        'rsi_14', 'rsi_slope_5', 'stochastic_k', 'stochastic_d', 'cci_20',
        'volume_sma_ratio', 'obv_slope', 'vwap_deviation',
        'volume_profile_poc_dist', 'volume_trend_5d',
        'swing_high_20', 'swing_low_20',
        'distance_to_resistance', 'distance_to_support',
        'higher_highs_5d', 'higher_lows_5d',
        'vix_level', 'vix_regime',
        'spy_correlation_20d', 'market_breadth_ratio'
    ]
    ...
    def _fallback_prediction(self, features: Dict[str, float]) -> Tuple[Direction, float]:
        ...
        momentum_score = (
            (features.get('rsi_14', 50) - 50) / 50 * 0.3 +
            features.get('rsi_slope_5', 0) * 0.1
        )
...
class SHAPExplainer:
    ...
    def _group_by_category(self, feature_shap: Dict[str, float]) -> Dict[str, float]:
        ...
        groups = {
            'VOLATILITY_SPIKE': ['atr_14', 'atr_percent_14', 'bollinger_width', 'volatility_regime'],
            'TREND_STRENGTH': ['adx_14', 'price_vs_sma_20', 'price_vs_sma_50', 'price_vs_sma_200'],
            'MOMENTUM_SHIFT': ['rsi_14', 'rsi_slope_5', 'macd_histogram', 'macd_line', 'macd_signal'],
            'SUPPORT_RESISTANCE': ['distance_to_support', 'distance_to_resistance', 'swing_high_20', 'swing_low_20'],
...
class BiasEngineV2:
    ...
    def _tag_feature_groups(self, features: Dict[str, float]) -> Dict[str, Any]:
        ...
        return {
            ...
            'SUPPORT_RESISTANCE': (
                features.get('distance_to_support', 999) < features.get('atr_14', 1) or
                features.get('distance_to_resistance', 999) < features.get('atr_14', 1)
            ),
            'MARKET_BREADTH': features.get('market_breadth_ratio', 1) > 1.5 or 
                              features.get('market_breadth_ratio', 1) < 0.7,
