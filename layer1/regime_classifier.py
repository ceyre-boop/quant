...
from contracts.types import (
    RegimeState, VolRegime, TrendRegime, RiskAppetite,
    MomentumRegime, EventRisk
)
...
class RegimeClassifier:
    ...
    def _calculate_composite(
        ...
        trend_score = {'STRONG_TREND': 1.0, 'WEAK_TREND': 0.7, 'RANGING': 0.4, 'CHOPPY': 0.2}
        risk_score = {'RISK_ON': 1.0, 'NEUTRAL': 0.6, 'RISK_OFF': 0.2}
        mom_score = {'ACCELERATING': 1.0, 'STEADY': 0.7, 'DECELERATING': 0.4, 'REVERSING': 0.2}
