...
Forex backtest:   11/11 pairs at 30+ trades, 7/11 positive Sharpe
                  Best: GBPUSD +0.59 | EURUSD +0.36 | GBPJPY +0.34
Signal layers:    Macro (IRP+RRD) + CB events + Calendar (QE + March JPY)
Charts:           logs/charts/ — 4 PNGs auto-generated by plot_forex_results.py
Cache bug fixed:  data_fetcher CACHE_DIR now writes to project root (not ~/)
Missing edges:    COT data (Dalio Q3), CPI surprise fade (Edge 2), DXY overlay
