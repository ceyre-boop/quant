...
from data.schema import (
    FeatureRecordSchema, BiasOutputSchema, RiskOutputSchema,
    GameOutputSchema, EntrySignalSchema, PositionSchema, AccountStateSchema,
    DataQuality
)
...
class DataValidator:
    ...
    def validate_json_file(
        ...
        record_type: str = 'feature_record'
    ) -> ValidationResult:
