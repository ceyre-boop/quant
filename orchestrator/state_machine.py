...
from contracts.types import (
    Direction, BiasOutput, RiskOutput, GameOutput,
    PositionState, EntrySignal
)
...
class SymbolStateMachine:
    ...
    TRANSITIONS = {
        ...
        SymbolState.SCANNING: [SymbolState.ENTRY_PENDING, SymbolState.IDLE, SymbolState.ERROR],
        SymbolState.ENTRY_PENDING: [SymbolState.IN_POSITION, SymbolState.SCANNING, SymbolState.ERROR],
        SymbolState.IN_POSITION: [SymbolState.EXIT_PENDING, SymbolState.COOLDOWN, SymbolState.ERROR],
        SymbolState.EXIT_PENDING: [SymbolState.COOLDOWN, SymbolState.ERROR],
        SymbolState.COOLDOWN: [SymbolState.IDLE, SymbolState.SCANNING, SymbolState.ERROR],
    ...
    def get_symbols_in_state(self, state: SymbolState) -> List[str]:
        ...
        return [
            symbol for symbol, ctx in self._contexts.items()
            if ctx.state == state
        ]
