...
configs = [
    # Standard
    {
        ...
        'payload': {'model': 'moonshot-v1-8k', 'messages': [{'role': 'user', 'content': 'Hi'}], 'max_tokens': 10}
    },
    # No Bearer prefix
    {
    ...
    # Different model
    {
        ...
        'url': 'https://api.moonshot.cn/v1/chat/completions',
        'headers': {'Authorization': f'Bearer {key}', 'Content-Type': 'application/json'},
        'payload': {'model': 'moonshot-v1-32k', 'messages': [{'role': 'user', 'content': 'Hi'}], 'max_tokens': 10}
    },
    # kimi-latest model
    {
        ...
        'url': 'https://api.moonshot.cn/v1/chat/completions',
        'headers': {'Authorization': f'Bearer {key}', 'Content-Type': 'application/json'},
        'payload': {'model': 'kimi-latest', 'messages': [{'role': 'user', 'content': 'Hi'}], 'max_tokens': 10}
    },
