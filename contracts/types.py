...
class BiasOutput:
    ...
    narrative_modifier: float = 0.0
    narrative_summary: str = ""
    narrative_confidence: str = "LOW"
    narrative_key_risks: List[str] = field(default_factory=list)
    narrative_catalysts: List[str] = field(default_factory=list)
    narrative_consensus: float = 0.0
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            'narrative_modifier': self.narrative_modifier,
            'narrative_summary': self.narrative_summary,
            'narrative_confidence': self.narrative_confidence,
            'narrative_key_risks': self.narrative_key_risks,
            'narrative_catalysts': self.narrative_catalysts,
            'narrative_consensus': self.narrative_consensus,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'BiasOutput':
        return cls(
            ...
            narrative_modifier=data.get('narrative_modifier', 0.0),
            narrative_summary=data.get('narrative_summary', ""),
            narrative_confidence=data.get('narrative_confidence', "LOW"),
            narrative_key_risks=data.get('narrative_key_risks', []),
            narrative_catalysts=data.get('narrative_catalysts', []),
            narrative_consensus=data.get('narrative_consensus', 0.0),
...
class VetoRecord:
    ...
    veto_reason:         str
    signal_that_was_vetoed: Optional[Dict[str, Any]] = None
